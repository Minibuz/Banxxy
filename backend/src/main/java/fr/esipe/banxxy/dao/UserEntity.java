...
public class UserEntity {
    ...
    /**
     * Returns a list of this user's transactions.
     *
     * @return transactions A list of this user's transactions. (List<TransactionEntity>)
     */
    ...
    /**
     * Sets a new transactions list for this user.
     *
     * @param transactions This user's new transactions list. (List<TransactionEntity>)
     */
